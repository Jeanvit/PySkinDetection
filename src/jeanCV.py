...
class skinDetector(object):
	...
	#function to process the image and segment the skin using the HSV colorspace, followed by the watershed algorithm
	def find_skin(self):
	...
	def _color_segmentation(self):
		...
		lower_YCbCr_values = np.array((0, 138, 67))
		upper_YCbCr_values = np.array((255, 173, 133))
	...
	def _region_based_segmentation(self):
		...
		image_marker32 = np.int32(image_marker) #convertion to the 32SC1 format
